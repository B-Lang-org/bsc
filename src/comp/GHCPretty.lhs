...
3.  Some random useful extra combinators are provided.
        ...
        sep (sep) is either like hsep or like vcat, depending on what fits
...
aboveNest (TextBeside s sl p) g k q = textBeside_ s sl rest
                                    where
                                      k1   = k - sl
                                      rest = case p of
                                                Empty -> k1 `seq` nilAboveNest g k1 q
                                                other -> k1 `seq` aboveNest  p g k1 q
aboveNest _ _ _ _ = internalError "bad case (Above or Beside) in aboveNest"
\end{code}
...
sep1 _ _ _ _ = internalError "bad case in sep1"
...
best OneLineMode w r p
  ...
  where
    ...
    get _ = internalError "bad case in OneLineMode/get"
...
best mode w r p
  ...
  where
    ...
    get _ _ = internalError "bad case in bestmode/get"
...
nonEmptySet _ = internalError "bad case in nonEmptySet"
\end{code}
...
oneLiner _ = internalError "bad case in oneLiner"
\end{code}
