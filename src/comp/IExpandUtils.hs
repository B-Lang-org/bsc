...
addHeapWHNF tag t pe@(P _ e) cell_name = do
...
toHeap tag e@(IRefT _ _ _ _) cell_name = return e -- XXX name improvement?
...
toHeapWHNF tag e@(IRefT _ _ _ _) cell_name = return e
