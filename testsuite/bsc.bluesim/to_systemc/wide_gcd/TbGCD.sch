...
SC_MODULE(mkTbGCD)
{
  ...
  sc_out<sc_bv<99> > gcd_start_num1;
  sc_out<sc_bv<99> > gcd_start_num2;

  // result method call ports
  sc_in<bool>       gcd_RDY_result;
  sc_in<sc_bv<99> > gcd_result;
  ...
  SC_CTOR(mkTbGCD)
    : CLK("CLK"), RST_N("RST_N"),
      ...
      count1("0x5aaaaaaaaaaaaaaaaaaaaaaaa"),
      count2("0x5aaaaaaaaaaaaaaaaaaaaaaaa"),
      tbresult("0x5aaaaaaaaaaaaaaaaaaaaaaaa"), 
      in_reset(false)
  {
