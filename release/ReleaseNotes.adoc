...
* Updates to BSV Language Reference Guide
* Adds back the BH (Bluespec Haskell/Classic) Reference Guide with updates, in `doc/`.
...
* Miscellaneous small bugfixes and improvements (`BRAM_PORT`, bypass FIFO adapter, bypass FIFOs)
